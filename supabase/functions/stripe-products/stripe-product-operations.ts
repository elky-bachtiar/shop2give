// Stripe Products API - Business Logic
/// <reference path="../utils/deno.d.ts" />
// This file contains all the function implementations for Stripe product operations

import 'jsr:@supabase/functions-js/edge-runtime.d.ts';
import { createClient } from '@supabase/supabase-js';
import Stripe from 'stripe';
import type { ProductRequest, PriceData, ApiResponse } from '../types/api.ts';
...
const stripe = new Stripe(Deno.env.get('STRIPE_SECRET_KEY') || '', {
  apiVersion: '2025-05-28.basil', // Updated to match SDK expectations
});
