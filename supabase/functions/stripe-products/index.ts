...
import { USER_ROLES, type ApiResponse, type ProductRequest } from "../types/api.ts";

// Import utilities
import { Auth, type AuthUser } from "../utils/auth.ts";
import { DEFAULT_CORS_HEADERS, handleCorsPreflightRequest } from "../utils/cors.ts";
...
const rateLimiter = createRateLimiter('stripe-products', 'global', 60, 60);
...
Deno.serve(async (req): Promise<Response> => {
  ...
  return response || new Response(null, { status: 204, headers: DEFAULT_CORS_HEADERS });
  }
