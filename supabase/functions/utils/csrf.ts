...
const csrfTokens = new Map<string, TokenInfo>();
...
export async function csrfProtection(
  ...
  try {
    ...
    const isValidToken = validateCsrfToken(data.user.id, csrfToken);
    return { 
      valid: isValidToken, 
      error: isValidToken ? undefined : 'Invalid or expired CSRF token', 
