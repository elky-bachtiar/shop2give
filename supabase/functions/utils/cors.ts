...
export const DEFAULT_CORS_HEADERS = {
  ...
  'Access-Control-Allow-Headers': 'Content-Type, Authorization, X-Client-Info, authorization, x-client-info, apikey, content-type',
...
/**
 * Add CORS headers to any headers object
 * @param headers - Response headers object
 * @returns Headers with CORS headers added
 */
export function addCorsHeadersToObject(headers: Record<string, string> = {}): Record<string, string> {
